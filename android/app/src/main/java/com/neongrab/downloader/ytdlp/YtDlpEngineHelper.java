...
public final class YtDlpEngineHelper {
    ...
    private static final long UPDATE_INTERVAL_MS = 24 * 60 * 60 * 1000L; // 24 hours
    ...
    private static void addSiteCompatArgs(YoutubeDLRequest request, String url) {
        ...
        if (isYouTubeUrl(lowerUrl)) {
            ...
            /* Adult sites need desktop UA + video page as referer to bypass bot-checks */
            request.addOption("--user-agent", DESKTOP_UA);
    ...
    private static boolean isAdultSiteUrl(String lowerUrl) {
        return lowerUrl.contains("xhamster.com") || lowerUrl.contains("xhamster.desi")
                || lowerUrl.contains("pornhub.com") || lowerUrl.contains("xvideos.com")
                || lowerUrl.contains("xnxx.com") || lowerUrl.contains("redtube.com")
                || lowerUrl.contains("youporn.com") || lowerUrl.contains("tube8.com")
                || lowerUrl.contains("spankbang.com") || lowerUrl.contains("tnaflix.com")
                || lowerUrl.contains("drtuber.com") || lowerUrl.contains("hclips.com");
    }
