...
**[Download NeonGrab-1.3.19-arm64.apk](https://github.com/Mostafijemon24/NeonGrab/releases/download/v1.3.19/NeonGrab-1.3.19-arm64.apk)** (~4.3 MB lean build)
...
|-------|----------|--------------|
| **v1.3.19 lean** | ~4.3 MB | + ~47 MB engine download |
...
| v1.3.10 lean | ~4.3 MB | + ~47 MB engine download |
